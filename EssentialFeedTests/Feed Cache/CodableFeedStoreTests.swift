...
final class CodableFeedStoreTests: XCTestCase, FailableFeedStore {
    ...
    func test_retrieve_deliversFailureOnRetrievalError() {
        ...
        assertThatRetrieveDeliversFailureOnRetrievalFailure(on: sut)
    }
    ...
    func test_delete_deliversNoErrorOnOnEmptyCache() {
        let sut = makeSUT()
    ...
    func test_delete_deliversErrorOnDeletionError() {
        ...
        assertThatDeletieDeliversErrorOnInsertionError(on: sut)
    }
