...
//  EssentialFeedTests
//
//  Created by Matias Glessi on 25/01/2023.
//
...
class URLSessionHTTPClientTests: XCTestCase {
    ...
    func test_getFromURL_failsOnRequestError() {
        ...
        if let recievedError = recievedError as NSError? {
    ...
    func test_getFromURL_succeedsWithEmptyDataWithHTTPURLResponseWithNilData() {
